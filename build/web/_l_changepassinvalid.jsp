<%-- 
    Document   : changepassinvalid
    Created on : Aug 24, 2014, 9:56:18 AM
    Author     : Hitesh Gupta
--%>
...
<div id="content" style="background-color: white;border-right:2px solid black;margin-top:2.5%;margin-left: 2.5%;height:90%;width:35%;float:left;">
    <h1 class="font" style="text-shadow: 5px 5px 5px #FF6666; color:red;" >CREATED<br>INVALID<br>PASSWORD</h1>         
</div> 
