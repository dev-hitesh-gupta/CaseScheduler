...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/uphome.jsp");
...
try{
	...
	while(rs1.next())
	{
                sql_stmnt= "SELECT crno,srno,csno,case_no,case_type,case_year FROM "+request.getParameter("list")+"_sync,case_master where csno like 'LOKESH SINHAL' or csno like concat('%',case_type,'-',case_no,'-',case_year,'%') and crid = '"+rs1.getString("crid")+"' group by csno";
